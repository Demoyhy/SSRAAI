...
class Trainer(object):
    ...
    def train(self, display=True):
        for epoch in range(1, self.param_dict['epoch_num'] + 1):
            ...
            if seen_valid_acc > self.min_dif:
                ...
                # save model
                save_model_data_dir = '/data0/yanghy/workplace/DeepAAI-main/c_1/'  ###'deep_aai_kmer_embedding_cls_trainer_seed=0_batch=32'
                ...
                same_model_param_path = osp.join(save_model_data_dir, self.trainer_info + '_param.pkl')
    ...
    def evaluate_model(self):
        # load param
        current_path = '/data0/yanghy/workplace/DeepAAI-main/c_1/'
        ...
        model_file_path = osp.join(current_path, 'deep_aai_kmer_embedding_cls_trainer_seed={}_batch=32_param.pkl'.format(self.param_dict['seed']))
